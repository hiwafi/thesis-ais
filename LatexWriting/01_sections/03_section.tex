...
\begin{itemize}
    \item The ship's STW can be calculated using vector component of the SOG and current speed. The direction used will be according to True North. \cite{Yang.2020,Zhou.2020}
    ...
    \begin{itemize}
        ...
        \end{equation}
    \end{itemize}
    \item This principle is applied to the following Python script.
